...
const protectedFiles = [
  ...
  ['migration-ledger-bootstrap-runner.js', 1024 * 1024],
  ['migration-ledger-bootstrap-evidence-verification.js', 1024 * 1024],
  ['migration-runner.js', 2 * 1024 * 1024],
  ['workspace-topology-verification.js', 1024 * 1024],
  ['workspace-source-integrity.js', 1024 * 1024],
  ['preview-activation-preflight.js', 1024 * 1024],
  ['readiness-check.js', 1024 * 1024],
  ['deployment-check.js', 1024 * 1024],
  ['uat-gate-check.js', 1024 * 1024],
  ['release-candidate-gate.js', 2 * 1024 * 1024],
  ['release-manifest-verification.js', 2 * 1024 * 1024]
];
