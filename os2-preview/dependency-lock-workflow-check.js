...
requireMarkers(workflow, [
  ...
  'test ! -e node_modules',
  'chmod 700 "$LOCK_TEMP_ROOT" "$LOCK_EVIDENCE_ROOT"',
  ...
  "evidence.check !== 'dependency-lock-generation'",
  "evidence.application !== 'talk2me-os2-preview'",
  "evidence.database !== 'kloka_talk2me'",
  'evidence.packageLockSha256 !== digest',
  'evidence.packageLockVerifiedAfterPublication !== true',
  'evidence.lifecycleScriptsExecuted !== false',
  'evidence.fullParentEnvironmentInherited !== false',
  'evidence.productionMutationEnabled !== false',
  ...
  'verify:workspace-source-integrity',
...
requireOrder(workflow, [
  'Checkout controlled branch',
  'Set up Node.js 20',
  'Confirm manual event and immutable source identity',
  'Prepare private generation directories',
  'Resolve controlled Node and npm binaries',
  'Run controlled dependency lock generator',
  'Verify private generation evidence',
  'Run lock and workflow governance',
  'Capture pre-install protected source identity',
  'Install and validate generated lock',
  'Prove source continuity after installation',
  'Build review artifact',
  'Upload dependency lock review artifact'
], 'dependency lock workflow');
