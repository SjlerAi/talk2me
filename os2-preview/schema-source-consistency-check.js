...
requireAll(previewReadiness, ["process.env.DB_NAME !== 'kloka_talk2me'", 'preview-data-verification.js', "'verify:preview-data': 'node preview-data-verification.js'", '20260801_025_merge_authorisation_restore_pin.sql'], 'preview readiness');
