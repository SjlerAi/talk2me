...
requireMarkers(verifier, [
  ...
  'dependencyLockWorkflowGovernanceProtected: files.some', 'dependencyLockGenerationRunbookProtected: files.some',
  'dependencyLockWorkflowRunbookProtected: files.some', 'dependencyLockWorkflowProtected: files.some',
  ...
  'recoveryReadinessProtected: files.some', 'recoveryReleaseGateProtected: files.some', 'recoveryRunbookProtected: files.some',
...
requireMarkers(preflight, [
  ...
  "'dependency-lock-generator-check.js'", "'dependency-lock-workflow-check.js'", "'workspace-source-integrity.js'",
  "'workspace-source-integrity-check.js'", "'restore-test-governance-check.js'", "'restore-test-integration-check.js'",
  "'recovery-readiness-check.js'", "'recovery-release-gate.js'", 'dependencyLockVerified: true',
  'dependencyLockGovernanceVerified: true', 'dependencyLockGeneratorGovernanceVerified: true',
  'dependencyLockWorkflowGovernanceVerified: true', 'packageLockRequired: true', 'workspaceSourceIntegrityVerified: true',
...
const expectedOrder = [
  "'workspace-topology-verification.js'", "'dependency-lock-verification.js'", "'dependency-lock-governance-check.js'",
  "'dependency-lock-generator-check.js'", "'dependency-lock-workflow-check.js'", "'workspace-source-integrity.js'",
  "'workspace-source-integrity-check.js'", "'workspace-topology-governance-check.js'",
