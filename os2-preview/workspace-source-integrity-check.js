...
requireMarkers(verifier, [
  ...
  "['../.github/workflows/os2-preview-ci.yml', 1024 * 1024]", "['workspace-source-integrity.js', 2 * 1024 * 1024]",
...
requireMarkers(runbook, ['workspace-source-integrity.js','workspace-source-integrity-check.js','deterministic SHA-256 inventory','secure descriptor-based reads','source inventory digest','CI workflow file itself is part of the protected source inventory'], 'Activation runbook');
...
console.log(JSON.stringify({
  ok: true, check: 'workspace-source-integrity-governance', deterministicInventoryRequired: true,
  secureDescriptorReadsRequired: true, descriptorMetadataStabilityRequired: true, exactReadByteCountRequired: true,
  canonicalPathBindingRequired: true, hardLinkRejectionRequired: true, ownershipConsistencyRequired: true,
  boundedReadsRequired: true, duplicatePathRejectionRequired: true, migrationDirectoryPurityRequired: true,
  selfProtectionRequired: true, sourceGovernanceProtectionRequired: true, topologyGovernanceProtectionRequired: true,
  activationGovernanceProtectionRequired: true, ciWorkflowProtectionRequired: true, ciBuildEvidenceProtectionRequired: true,
